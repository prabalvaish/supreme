...
class Location extends MY_Controller {
	...
	public function add_location() {
		...
		'is_esic' => $this->input->post('is_esic'),
	...
	// Insert company allowances
	public function company_allowance_option() {
		$data = array(
		...
		var_dump($data);
		$result = $this->Location_model->add_company_allowances($data);
		if ($result == TRUE) {
	...
	// Company salary detection
	public function company_detection_option() {
		...
		$result = $this->Location_model->add_company_detection($data);
		if ($result == TRUE) {
			$Return['result'] = $this->lang->line('xin_employee_set_allowance_success');
		} else {
			$Return['error'] = $this->lang->line('xin_error_msg');
