			...
			if(in_array($_FILES['file']['type'],$csvMimes)){
				if(is_uploaded_file($_FILES['file']['tmp_name'])){
					...
					while(($line = fgetcsv($csvFile)) !== FALSE){
						...
						'password' => $line[5],
						'employee_id' => $line[6],
						'date_of_joining' => $line[7],
						'gender' => $line[8],
						'date_of_birth' => $line[9],
						'contact_no' => $line[10],
						/*'address' => $line[10],*/
						'company_id' => $line[11],
						'location_id' => $line[12],
						'department_id' =>$line[13],
						'sub_department_id' =>$line[14],
						'designation_id' => $line[15],
						'user_role_id' => $line[16],
						'marital_status' => $line[17],
						'is_active' => $line[18],
						'office_shift_id' => $line[19],
						'leave_categories' => $line[20],
						'created_at' => date('Y-m-d h:i:s')
						);
					$last_insert_id = $this->Employees_model->add($data);
					$immigration_data = array(
					'document_type_id' => $line[21],
					'document_number' => $line[22],
					'document_file' => $line[23],
					'issue_date' => $line[24],
					'expiry_date' => $line[25],
					'country_id' => $line[26],
					'eligible_review_date' => $line[27],
					...
					'work_email' => $line[29],
					'is_primary' => $line[30],
					'is_dependent' => $line[31],
					'personal_email' => $line[32],
					'contact_name' => $line[33],
					'address_1' => $line[34],
					'work_phone' => $line[35],
					'work_phone_extension' => $line[36],
					'address_2' => $line[37],
					'mobile_phone' => $line[38],
					'city' => $line[39],
					'state' => $line[40],
					'zipcode' => $line[41],
					'home_phone' => $line[42],
					...
					$document_data = array(
					'document_type_id' =>  $line[44],
					'date_of_expiry' =>  $line[45],
					'title' =>  $line[46],
					'notification_email' =>  $line[47],
					'description' =>  $line[48],
					'document_file' => $line[49],
					'is_alert' =>  $line[50],
					'employee_id' => $last_insert_id,
					'created_at' => date('d-m-Y'),
					);
					...
					'account_title' => $line[63],
					'account_number' => $line[64],
					'bank_name' => $line[65],
					'bank_code' => $line[66],
					'bank_branch' => $line[67],
					'employee_id' => $last_insert_id,
