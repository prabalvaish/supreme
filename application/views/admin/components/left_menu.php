...
<ul class="sidenav-inner py-1">
  ...
  <li class="<?php if(!empty($arr_mod['emp_open']))echo $arr_mod['emp_open'];?> sidenav-item"> <a href="#" class="sidenav-link sidenav-toggle"> <i class="sidenav-icon ion ion-ios-globe"></i>
    ...
    <ul class="sidenav-menu">
      ...
      <li class="sidenav-item <?php if(!empty($arr_mod['ann_active']))echo $arr_mod['ann_active'];?>"> <a class="sidenav-link" href="<?php echo site_url('admin/employees_summary');?>" ><?php echo $this->lang->line('xin_Summary');?> </a> </li>
      <?php } ?>
    </ul>
  </li>
  <?php } ?>
  ...
  <li class="<?php if(!empty($arr_mod['adm_open']))echo $arr_mod['adm_open'];?> sidenav-item"> <a href="#" class="sidenav-link sidenav-toggle"> <i class="sidenav-icon ion ion-md-business"></i>
    ...
    <ul class="sidenav-menu">
      ...
      <?php } ?>
      <?php if(in_array('11',$role_resources_ids)) { ?>
      <li class="sidenav-item <?php if(!empty($arr_mod['ann_active']))echo $arr_mod['ann_active'];?>"> <a class="sidenav-link" href="<?php echo site_url('admin/Company_Salary');?>" > <?php echo $this->lang->line('xin_company_set_salary');?> </a> </li>
      <?php } ?>
