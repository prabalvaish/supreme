...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <?php if (in_array('467', $role_resources_ids)) { ?>
      <li class="nav-item clickable"> <a href="<?php echo site_url('admin/payroll/advance_salary/'); ?>" data-link-data="<?php echo site_url('admin/payroll/advance_salary/'); ?>" class="mb-3 nav-link hrsale-link"> <span class="sw-icon ion ion-ios-cash"></span> <?php echo $this->lang->line('xin_advance_salary'); ?>
          <div class="text-muted small"><?php echo $this->lang->line('xin_setup'); ?> <?php echo $this->lang->line('xin_advance_salary'); ?></div>
        </a> </li>
    <?php } ?>
  </ul>
</div>
