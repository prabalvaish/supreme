...
<div class="row">
  <div class="<?php echo $cmdp_1st;?>">
    <div class="card mb-4">
      <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('xin_payslip');?> - </strong> <?php echo date("F, Y", strtotime($payment_date));?></span>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
					  ...
					  ?>
                      <tr>
                        <td><strong><?php echo $sl_allowances->allowance_title;?> (<?php echo $allowance_amount_opt;?>) (<?php echo $allowance_opt;?>):</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_allowances->allowance_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                <tbody>
                  ...
                  <?php
					$total_earning = $total_allowances + $overtime_amount + $commissions_amount + $other_payments_amount + $saudi_gosi;
