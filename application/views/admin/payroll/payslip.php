    ...
    <div class="card">
      ...
      <div class="box-body">
        <div id="accordion">
                  ...
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      <?php $allowance_amount = 0; foreach($allowances->result() as $sl_allowances) { 
                        $allowance_amount = $sl_allowances->DA+$sl_allowances->HRA + $sl_allowances->Conv_Allow + $sl_allowances->Other_Allow +$sl_allowances->LWW; 
                       ?>
                      
                      <tr>
                        <td><strong>DA :</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_allowances->DA);?></span></td>
                      </tr><tr>
                        <td><strong>HRA :</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_allowances->HRA);?></span></td>
                        </tr><tr>
                        <td><strong>Conv Allow :</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_allowances->Conv_Allow);?></span></td>
                        </tr><tr>
                        <td><strong>Other Allow:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_allowances->Other_Allow);?></span></td>
                        </tr><tr>
                        <td><strong>LWW:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_allowances->LWW);?></span></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      <tr>
                        <td><strong><?php echo $sl_commissions->commission_title;?> (<?php echo $commission_amount_opt;?>) (<?php echo $commission_opt;?>):</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_commissions->commission_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      <?php $statutory_deductions_amount = $sl_statutory_deductions->PF + $sl_statutory_deductions->PT + $sl_statutory_deductions->ESIC + $sl_statutory_deductions->TDS + + $sl_statutory_deductions->LWF ?>
                      <tr>
                        <td><strong>PT:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_statutory_deductions->PT);?></span></td>
                      </tr><tr>
                      <td><strong>PF:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_statutory_deductions->PF);?></span></td>
                      </tr><tr>
                      <td><strong>ESIC:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_statutory_deductions->ESIC);?></span></td>
                      </tr><tr>
                      <td><strong>TDS:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_statutory_deductions->TDS);?></span></td>
                      </tr><tr>
                      <td><strong>LWF:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_statutory_deductions->LWF);?></span></td>
                      </tr>
                      <?php 
                      } 
                      ?>
                  ...
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      <?php
						...
						?>
                      <tr>
                        <td><strong><?php echo $sl_other_payments->payments_title;?> (<?php echo $other_amount_opt;?>) (<?php echo $other_opt;?>):</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_other_payments->payments_amount);?></span></td>
                      </tr>
                      <?php } ?>
                      <tr>
          ...
          <div class="card hrsale-payslip">
            <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#set_advance_salary" aria-expanded="false"> <strong><?php echo $this->lang->line('xin_advance_deducted_salary');?></strong> </a> </div>
            <div id="set_advance_salary" class="collapse" data-parent="#accordion" style="">
              <div class="box-body ml-3 mr-3">
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                <tbody>
                  ...
                  <tr>
                    <td><strong><?php echo $this->lang->line('xin_payroll_total_allowance');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($allowance_amount);?></span></td>
                  </tr>
                  <?php endif;?>
                  ...
                  <?php $advance_salary_tkn = $advance_salary_amount;?>
                  <?php else: ?>
                  <?php $advance_salary_tkn = 0;?>
                  <?php endif;?>
                  ...
                  <?php
					...
					$total_earning = $bs + (float)$allowance_amount; + $overtime_amount + $commissions_amount + $other_payments_amount + $saudi_gosi;
					$total_deduction = $loan_de_amount + $statutory_deductions_amount;
					$total_net_salary = $total_earning - $total_deduction;
					$total_net_salary = $total_net_salary - $advance_salary_tkn;
				  ?>
                  <tr>
