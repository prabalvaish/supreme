        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <label for="title"><?php echo $this->lang->line('xin_e_details_ename');?></label>
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_e_details_ename');?>" data-placeholder="<?php echo $this->lang->line('xin_jobs_employer');?>"  name="user_id" type="text" value="<?php echo $employer_id;?>">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_job_is_featuredmail');?>" name="job_title" type="text" value="<?php echo $job_title;?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control" name="status" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('dashboard_xin_status');?>">
                <option value="1" <?php if($status=='1'):?> selected <?php endif;?>><?php echo $this->lang->line('xin_call_for_interview');?></option>
                <option value="2" <?php if($status=='2'):?> selected <?php endif;?>><?php echo $this->lang->line('xin_pending');?></option>
                  <option value="3" <?php if($status=='3'):?> selected <?php endif;?>><?php echo $this->lang->line('xin_accepted');?></option>
                    <option value="4" <?php if($status=='4'):?> selected <?php endif;?>><?php echo $this->lang->line('xin_rejected');?></option>
                      <option value="5" <?php if($status=='5'):?> selected <?php endif;?>><?php echo $this->lang->line('xin_approved');?></option>
          ...
          <!-- <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" name="is_featured" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_job_is_featured');?>">
            </div>
          </div> -->

          <div class="col-md-6">
            <div class="form-group">
              <label for="date_of_closing"><?php echo $this->lang->line('xin_date_of_closingtime');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_date_of_closingtime');?>" name="is_featured" type="time" value="<?php echo $is_featured;?>">
            </div>
          </div>
