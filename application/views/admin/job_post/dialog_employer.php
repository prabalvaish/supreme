  ...
  <div class="modal-body">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
              <label for="is_active" class="control-label"><?php echo $this->lang->line('xin_employees_active');?></label>
              <select class="form-control" name="is_active" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employees_active');?>">
                <option value="1" <?php if($is_active==1):?> selected="selected" <?php endif;?>><?php echo $this->lang->line('xin_yes');?></option>
                <option value="0" <?php if($is_active==0):?> selected="selected" <?php endif;?>><?php echo $this->lang->line('xin_no');?></option>
              </select>
            </div>
          </div>
          <div class="col-md-6">
