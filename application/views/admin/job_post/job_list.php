              ...
              <div class="col-md-6">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <label for="title"><?php echo $this->lang->line('xin_e_details_ename');?></label>
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_e_details_ename');?>" name="user_id" type="text" value="">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="title"><?php echo $this->lang->line('xin_job_is_featuredmail');?></label>
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_job_is_featuredmail');?>" name="job_title" type="text" value="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="status"><?php echo $this->lang->line('dashboard_xin_statustyp');?></label>
                      <select class="form-control" name="status" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('dashboard_xin_status');?>">
                        <option value="1"><?php echo $this->lang->line('xin_call_for_interview');?></option>
                        <option value="2"><?php echo $this->lang->line('xin_pending');?></option>
                        <option value="3"><?php echo $this->lang->line('xin_accepted');?></option>
                        <option value="4"><?php echo $this->lang->line('xin_rejected');?></option>
                        <option value="5"><?php echo $this->lang->line('xin_approved');?></option>
                      </select>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <!-- <div class="col-md-6">
                    <div class="form-group">
                      <label for="vacancy"><?php echo $this->lang->line('xin_job_is_featuredmail');?></label>
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_job_is_featuredmail');?>" name="is_featured" type="text" value="">
                    </div>
                  </div> -->
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="date_of_closing" class="control-label"><?php echo $this->lang->line('xin_date_of_closingtime');?></label>
                      <input type="time" class="form-control time" placeholder="<?php echo $this->lang->line('xin_date_of_closingtime');?>" name="is_featured" value="">
                    </div>
                  </div>
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            ...
            <th><?php echo $this->lang->line('xin_e_details_ename');?></th>
            <th ><?php echo $this->lang->line('dashboard_position');?></th>
            <th><i class="fa fa-calendar"></i> <?php echo $this->lang->line('xin_date_of_closing');?></th>
            <th><?php echo $this->lang->line('xin_posted_date');?></th>
            <th><?php echo $this->lang->line('xin_number_of_positions');?></th>
            <th><?php echo $this->lang->line('dashboard_xin_status');?></th>
            <th><?php echo $this->lang->line('dashboard_xin_statusmail');?></th>
