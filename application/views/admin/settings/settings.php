  ...
  <div class="row no-gutters row-bordered row-border-light">
    <div class="col-md-3 pt-0">
      <div class="list-group list-group-flush account-settings-links">
        ...
        <a class="list-group-item list-group-item-action <?php echo $active466;?>" data-toggle="list" href="#account-topmenu"><i class="fas fa-list-ol text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_manage_top_menu');?></a>
        <?php } ?> </div>
    </div>
    <div class="col-md-9">
          ...
          <div class="card-body pb-2">
            <div class="card-block">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="dashboard_option" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
                      ...
                      <option value="dashboard_light_2" <?php if($dashboard_option=='dashboard_light_2'){?> selected <?php }?>> <?php echo $this->lang->line('xin_hrsale_dashboard_2light');?></option>
                      <option value="dashboard_dark_2" <?php if($dashboard_option=='dashboard_dark_2'){?> selected <?php }?>> <?php echo $this->lang->line('xin_hrsale_dashboard_2dark');?></option>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="form-label"><?php echo $this->lang->line('xin_login_page_text');?> </label>
                    <textarea class="form-control" name="login_page_text" id="login_page_text" rows="3"><?php echo $login_page_text;?></textarea>
                    <small class="text-muted"><i class="fas fa-hand-point-up"></i> <?php echo $this->lang->line('xin_login_page_text_desc');?></small> </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
            ...
            <div class="col-xl-12">
              <div class="nav-tabs-top mb-4">
                <ul class="nav nav-tabs">
                  <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#xin_system_logos"><?php echo $this->lang->line('xin_system_logos');?></a> </li>
                  <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#xin_theme_signin_page_logo_title"><?php echo $this->lang->line('xin_theme_signin_page_logo_title');?></a> </li>
                  <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#xin_theme_job_page_logo_title"><?php echo $this->lang->line('xin_theme_job_page_logo_title');?></a> </li>
                  <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#xin_theme_payroll_logo_title"><?php echo $this->lang->line('xin_theme_payroll_logo_title');?></a> </li>
                </ul>
                <div class="tab-content">
              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <select multiple="multiple" name="hr_top_menu[]" size="20" id="duallistbox-example">
                    ...
                    <option value="assets" <?php if(in_array('assets',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_assets');?></option>
                    <?php } ?>
                    <?php if(!in_array('25',$role_resources_ids) && in_array('26',$role_resources_ids)) {?>
                    <option value="assets_category" <?php if(in_array('assets_category',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_assets_category');?></option>
                    <?php } ?>
                    <?php if(in_array('25',$role_resources_ids) && !in_array('26',$role_resources_ids)) {?>
                    <option value="assets" <?php if(in_array('assets',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_assets');?></option>
                    <?php } ?>
                    ...
                    <option value="trainers_list" <?php if(in_array('trainers_list',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('left_trainers_list');?></option>
                    <?php } ?>
                    <?php  if(!in_array('54',$role_resources_ids) && in_array('56',$role_resources_ids) && !in_array('55',$role_resources_ids)) {?>
                    <option value="trainers_list" <?php if(in_array('trainers_list',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('left_trainers_list');?></option>
                    <?php } ?>
                    <?php  if(!in_array('54',$role_resources_ids) && !in_array('56',$role_resources_ids) && in_array('55',$role_resources_ids)) {?>
                    <option value="training_type" <?php if(in_array('training_type',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('left_training_type');?></option>
                    <?php } ?>
                    <?php } ?>
                    <?php if(in_array('8',$role_resources_ids)) { ?>
                    <option value="holiday" <?php if(in_array('holiday',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('left_holidays');?></option>
                    <?php } ?>
                    <?php  if(in_array('92',$role_resources_ids) || in_array('443',$role_resources_ids) || in_array('444',$role_resources_ids)) { ?>
                    <option value="hr_import" <?php if(in_array('hr_import',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_hr_imports');?></option>
                    <?php } ?>
                    ...
                    <option value="hr_report" <?php if(in_array('hr_report',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_hr_report_title');?></option>
                    <?php } ?>
                    <?php  if(in_array('393',$role_resources_ids)) { ?>
                    <option value="custom_fields" <?php if(in_array('custom_fields',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_hrsale_custom_fields');?></option>
                    <?php } ?>
                    <?php  if(in_array('80',$role_resources_ids) && in_array('81',$role_resources_ids)) {?>
                    <option value="hr_payees_payers" <?php if(in_array('hr_payees_payers',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_hr_payees_payers');?></option>
                    <?php } ?>
                    <?php  if(in_array('80',$role_resources_ids) && !in_array('81',$role_resources_ids)) {?>
                    <option value="acc_payees" <?php if(in_array('acc_payees',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_acc_payees');?></option>
                    <?php } ?>
                    <?php  if(!in_array('80',$role_resources_ids) && in_array('81',$role_resources_ids)) {?>
                    <option value="acc_payers" <?php if(in_array('acc_payers',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_acc_payers');?></option>
                    <?php } ?>
                    <?php if($system[0]->is_active_sub_departments=='yes'){?>
                    <?php  if(in_array('3',$role_resources_ids)) { ?>
                    <option value="sub_department" <?php if(in_array('sub_department',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_hr_sub_departments');?></option>
                    <?php } ?>
                    <?php } ?>
                    <?php if($system[0]->module_events=='true'){?>
                    <?php  if(in_array('98',$role_resources_ids) && in_array('99',$role_resources_ids)) {?>
                    <option value="events_meetings" <?php if(in_array('events_meetings',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_hr_events_meetings');?></option>
                    <?php } ?>
                    <?php  if(in_array('98',$role_resources_ids) && !in_array('99',$role_resources_ids)) {?>
                    <option value="events" <?php if(in_array('events',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_hr_events');?></option>
                    <?php } ?>
                    <?php  if(!in_array('98',$role_resources_ids) && in_array('99',$role_resources_ids)) {?>
                    <option value="meetings" <?php if(in_array('meetings',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_hr_meetings');?></option>
                    <?php } ?>
                    <?php } ?>
                    <?php if($system[0]->module_orgchart=='true'){?>
                    <?php  if(in_array('96',$role_resources_ids)) { ?>
                    <option value="orgchart" <?php if(in_array('orgchart',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_org_chart_title');?></option>
                    <?php } ?>
                    <?php } ?>
                    <?php  if(in_array('60',$role_resources_ids)) { ?>
