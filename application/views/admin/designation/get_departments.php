...
<?php $result1 = $this->Company_model->ajax_company_info($company_id);
?>


<?php $system = $this->Xin_model->read_setting_info(1);?>
<div class="form-group" id="company_ajax">
...
<div class="form-group" id="ajx_department">
  ...
  <select class="select2" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_location');?>" name="location_id" id="aj_subdepartments">
    <option value=""></option>
    <?php foreach($result1 as $deparment) {?>
    <option value="<?php echo $deparment->location_id ?>"><?php echo $deparment->location_name?></option>
    <?php } ?>
  </select>
</div>
<?php
