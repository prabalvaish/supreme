...
<?php echo form_open('admin/designation/update/'.$designation_id, $attributes, $hidden);?>
  <div class="modal-body">
     <div class="row">
      ...
      <div class="col-md-4">   
        <div class="form-group">
        <label for="designation"><?php echo $this->lang->line('xin_designation_salary');?></label>
        <input type="text" class="form-control" name="basic_salary" value="<?php echo $basic_salary;?>">
        </div>
      </div>
    </div>
    <div class="row">
