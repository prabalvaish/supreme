    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <!-- Salary Type -->
          <!-- <div class="form-group">
        <label for="name"><?php echo $this->lang->line('xin_salary'); ?></label>
        <select class="form-control" name="salary_type" id="aj_company" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_salary'); ?>">
          <option value=""></option>
          ...
          <!-- sallary -->
          <div class="form-group">
            <label for="name"><?php echo $this->lang->line('xin_designation_salary'); ?></label>
            <input type="text" class="form-control" name="basic_salary" placeholder="<?php echo $this->lang->line('xin_designation_salary'); ?>">
          </div>
