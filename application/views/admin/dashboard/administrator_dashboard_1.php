...
<?php 
$date =date('Y-m-d');
$total_leave = $this->Xin_model->total_leaves($date);
foreach ($total_leave as $count){
  $leave_count = $count->leave_number;
}
?>
          ...
          <div class="card-footer text-center py-3">
            <div class="row">
              <div class="col">
                ...
                <strong class="text-big"><?php echo ($abs); ?></strong>
              </div>
              <div class="col">
                <div class="text-muted small"><?php echo $this->lang->line('xin_emp_working'); ?></div>
                <strong class="text-big"><?php echo ($working); ?></strong>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card pt-2 mb-4">
          ...
          <div class="card-footer text-center py-3">
            <div class="row">
              <div class="col">
                <div class="text-muted small"><?php echo $this->lang->line('xin_absent'); ?></div>
                <strong class="text-big"><?php echo $abs-$leave_count; ?></strong>
              </div>
              <div class="col">
                <div class="text-muted small">On Leave</div>
                <strong class="text-big"><?php echo $leave_count; ?></strong>
              </div>
            </div>
          </div>
        </div>
