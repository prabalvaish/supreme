      ...
      <div class="row no-gutters row-bordered h-100">
        ...
        <div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center">
          ...
          <a href="javascript:void(0)" class="card-body media align-items-center text-body">
            ...
            <span class="media-body d-block ml-3">
              <span class="text-big font-weight-bolder"><?php echo $this->Employees_model->get_total_employees();?></span><br>
              <small class="text-muted"><?php echo $this->lang->line('xin_people');?></small>
            </span>
          </a>
        ...
        <div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center">
          ...
          <a href="javascript:void(0)" class="card-body media align-items-center text-body">
            ...
            <span class="media-body d-block ml-3">
              <span class="text-big font-weight-bolder"><?php echo employee_request_leaves();?></span><br>
              <small class="text-muted"><?php echo $this->lang->line('xin_attendance_total_leave');?></small>
            </span>
          </a>
        ...
        <div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center">
          ...
          <a href="javascript:void(0)" class="card-body media align-items-center text-body">
            ...
            <span class="media-body d-block ml-3">
              <span class="text-big font-weight-bolder"><?php echo $this->Xin_model->currency_sign(total_salaries_paid());?></span><br>
              <small class="text-muted"><?php echo $this->lang->line('dashboard_total_salaries');?></small>
            </span>
          </a>
