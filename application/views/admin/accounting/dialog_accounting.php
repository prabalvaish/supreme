          ...
          <div class="col-md-4">
            ...
            <div class="form-group" id="employee_ajaxx">
              ...
              <select id="payee_id" name="payee_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_acc_choose_a_payee');?>">
                ...
                <option value="<?php echo $employee->user_id;?>" <?php if($payee_id==$employee->user_id):?> selected="selected"<?php endif;?>> <?php echo $employee->first_name.' '.$employee->middle_name.' '.$employee->last_name;?></option>
                <?php } ?>
              </select>
            </div>
            <?php } else {?>
