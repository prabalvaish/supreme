              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <label for="salary_type"><?php echo $this->lang->line('xin_salary'); ?></label>
                      <select class="form-control" name="salary_type" id="salary_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_salary'); ?>">
                      <option value=""><?php echo $this->lang->line('xin_select_one'); ?></option>
                      <option value="1"><?php echo $this->lang->line('xin_payroll_monthly'); ?></option>
                      <option value="2"><?php echo $this->lang->line('xin_payroll_daily'); ?></option>
                      </select>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <input type="checkbox" id="is_esic" name="is_esic" value=1>
