...
?>
  ...
  <?php $allowances = $this->Location_model->getAllowances($location_id); ?>
  <?php $deduction = $this->Location_model->getDeduction($location_id); ?>
   <?php $esic = $this->Location_model->getEsic($location_id);
  ...
  <?php $designation = $this->Location_model->getDesignation($location_id);
  ?>
  ...
  <div class="modal-body">
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="col-md-6">
          <input type="checkbox" id="is_esic" name="is_esic" value=1 <?php echo ($is_esic == 1 ? 'checked' : ''); ?>>
          <label for="is_esic"> Opt Esic</label>
        </div>
      </div>
      <div class="col-sm-6">
