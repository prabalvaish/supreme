        ...
        <div class="form-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="company_prefix"><?php echo $this->lang->line('comapny_prefix');?></label>
                <input class="form-control" placeholder="<?php echo $this->lang->line('comapny_prefix');?>" name="prefix" type="text">
              </div>
