...
<!-- Preloader End -->
<div class="authentication-wrapper authentication-2 ui-bg-cover ui-bg-overlay-container px-4" style="background-image: url('<?php echo base_url();?>skin/hrsale_vendor/assets/img/bg/bg-3.jpg');">
    ...
    <div class="card">
        ...
        <!-- / Logo -->
        <h5 class="text-center text-muted font-weight-normal mb-4"><?php echo $this->lang->line('xin_hrsale_login_to_your_account');?></h5>
        <!-- Form -->
        ...
        <div class="form-group">
			...
			if($system[0]->employee_login_id=='username'):
				...
				$ilogn_info = 'administrator@ezmata.com';
				$ilogn_info2 = 'jsmt12@ezmata.com';
			endif;?>
