...
<?php $result1 = $this->Department_model->ajax_company_last_emp($company_id);?>


<div class="form-group">
  <label class="form-label"><?php echo $this->lang->line('left_location');?><i class="hrsale-asterisk">*</i></label>
...
<div class="form-group" id="emp_id_ajax">
  <label class="form-label" ><?php echo $this->lang->line('dashboard_employee_id');?><i class="hrsale-asterisk">*</i></label>
  <?php foreach($result1 as $Emp_id) {?>
  <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_employee_id'); ?>" name="employee_id"  value="<?php echo $Emp_id->Prefix?>">
  <?php } ?>
</div>
<script type="text/javascript">
$(document).ready(function(){	
