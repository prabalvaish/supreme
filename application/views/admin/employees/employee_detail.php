...
$pf_allow = $this->Employees_model->read_pf_allow($eid);
foreach ($pf_allow as $pf) {
  $allow = $pf->pf_allow;
  $tds_type = $pf->tds_type;
}
?>
<?php
...
<?php $designation_id = $this->Employees_model->getDesignation($eid);
foreach ($designation_id as $id) {
  $ids = $id->designation_id;
}
$overtimeamount = $this->Employees_model->getOvertimeAmount($ids);
?>
<?php 
$detail= $this->Employees_model->read_info($eid);
foreach($detail as $emp_detail){
  $customer = $emp_detail->location_name;
  $location_name = $emp_detail->department_name;
  $designation_name = $emp_detail->designation_name;
  $department_name = $emp_detail->department_name;
  $company_name = $emp_detail->name;
  $company_id = $emp_detail->company_id;
}
  // echo   $customer;
?>
            ...
            <div class="row no-gutters row-bordered row-border-light">
              <div class="col-md-3 pt-0">
                <div class="list-group list-group-flush account-settings-links"> <a class="list-group-item list-group-item-action active" data-toggle="list" href="#account-basic_info"> <i class="lnr lnr-user text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_basic'); ?></a> <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-profile_picture"> <i class="lnr lnr-picture text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_profile_picture'); ?>
                    <!--</a> <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-immigration"> <i class="lnr lnr-rocket text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_employee_immigration'); ?></a>-->
                    ...
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-document"> <i class="lnr lnr-file-add text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_document'); ?></a> <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-qualification"> <i class="lnr lnr-file-empty text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_qualification'); ?></a> <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-experience"> <i class="lnr lnr-hourglass text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_w_experience'); ?></a> <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-baccount"> <i class="lnr lnr-apartment text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_baccount'); ?></a> <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-cpassword"> <i class="lnr lnr-lock text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_cpassword'); ?>
                    </a> <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-security_level"> <i class="lnr lnr-link text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_esecurity_level_title'); ?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#transfer"> <i class="lnr lnr-link text-lightest"></i> &nbsp; Transfer</a>
                    <!--<a class="list-group-item list-group-item-action" data-toggle="list" href="#account-contract"> <i class="lnr lnr-pencil text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_contract'); ?></a>-->
                </div>
              </div>
              <div class="col-md-9">
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="account-basic_info">
                    <div class="card-body media align-items-center">
                      ...
                      <div class="media-body ml-4"> <a href="<?php echo site_url('admin/employees/send_offer/') . $user_id; ?>">
                          <label class="btn btn-outline-primary"> <?php echo $this->lang->line('xin_send_offer'); ?> </label>
                    ...
                    <div class="card-body">
                      ...
                      <div class="bg-white">
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="first_name"><?php echo $this->lang->line('xin_employee_middle_name'); ?><i class="hrsale-asterisk">*</i></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_middle_name'); ?>" name="first_name" type="text" value="<?php echo $first_name; ?>">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                  ...
                  <div class="tab-pane fade" id="transfer">
                    <div class="card-body media align-items-center">
                      ...
                      <div class="card-body">
                        <?php $attributes = array('name' => 'basic_info', 'id' => 'basic_info', 'autocomplete' => 'off'); ?>
                        <?php $hidden = array('user_id' => $user_id, 'u_basic_info' => 'UPDATE'); ?>
                        <?php echo form_open_multipart('admin/employees/transfer_info', $attributes, $hidden); ?>
                        <div class="bg-white">
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="customer_name">Customer Name</label>
                                <input class="form-control" placeholder="Customer Name" name="customer_name" type="text" value="<?php echo $customer; ?>" id="customer_name" readonly>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="Designation">Designation</label>
                                <input class="form-control" placeholder="Designation" name="Designation" type="text" value="<?php echo $designation_name; ?>" id="Designation" readonly>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="Designation">Department</label>
                                <input class="form-control" placeholder="Designation" name="Designation" type="text" value="<?php echo $department_name; ?>" id="Designation" readonly>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="Location">Location</label>
                                <input class="form-control" placeholder="Location" name="Location" type="text" value="<?php echo $location_name; ?>" id="Location" readonly>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                <!-- <?php $companies = $this->Xin_model->get_companies();
                                      ?> -->
                                <label for="first_name"><?php echo $this->lang->line('left_company'); ?><i class="hrsale-asterisk">*</i></label>
                                <input class="form-control" placeholder="<?php echo $this->lang->line('left_company'); ?>" name="Location" type="text" value="<?php echo $company_name; ?>" id="Location" readonly>
                                <input class="form-control" placeholder="<?php echo $this->lang->line('left_company'); ?>" name="company_id" type="text" value="<?php echo $company_id; ?>" id="company_id" hidden>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <?php $customer = $this->Employees_model->customer_detail($company_id); ?>
                                <label for="name">New <?php echo $this->lang->line('left_location'); ?><i class="hrsale-asterisk">*</i></label>
                                <select class="form-control" name="location_id1" id="location_id1" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_company'); ?>">
                                  <option value=""><?php echo $this->lang->line('left_company'); ?></option>
                                  <?php foreach ($customer as $cust) { ?>
                                    <option value="<?php echo $cust->location_id ?>"><?php echo $cust->location_name ?></option>
                                  <?php } ?>
                                </select>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group" id="department_ajax">
                                <label for="department">New <?php echo $this->lang->line('xin_hr_main_department'); ?><i class="hrsale-asterisk">*</i></label>
                                <select class="form-control" name="department_id1" id="department_id1" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_department'); ?>">
                            ...
                            <div class="col-md-6" id="subdepartment_ajax">
                              <div class="form-group">
                                <label for="designation">New <?php echo $this->lang->line('xin_hr_sub_department'); ?><i class="hrsale-asterisk">*</i></label>
                                <select class="form-control" name="subdepartment_id1" id="subdepartment_id1" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_hr_sub_department'); ?>">
                            ...
                            <div class="col-md-6" id="designation_ajax">
                              <div class="form-group">
                                <label for="designation">New <?php echo $this->lang->line('xin_designation'); ?><i class="hrsale-asterisk">*</i></label>
                                <select class="form-control" name="designation_id1" id="designation_id1" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_designation'); ?>">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input class="form-control date" placeholder="Transfer Date" name="transfer_date" type="text" value="" id="transfer_date" readonly>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div class="row no-gutters row-bordered row-border-light">
                ...
                <div class="col-md-9">
                  <div class="tab-content">
                      ...
                      <div class="card-body pb-2">
                        ...
                        <div class="bg-white">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <input type="radio" id="old" name="tds_type" <?php echo ($tds_type == '0') ? 'checked' : '' ?> value="0">
                                <label for="male">Old Regime For TDS</label><br>
                                <input type="radio" id="new" name="tds_type" <?php echo ($tds_type == '1') ? 'checked' : '' ?> value="1">
                                <label for="female">New Regime For TDS</label><br>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <input type="checkbox" id="pf_allow" name="pf_allow" value='1' <?php echo ($allow == 1 ? 'checked' : ''); ?>>
                              <label for="basic_salary">PF Opt In(If checked then PF will be deducted)<i class="hrsale-asterisk">*</i></label>
                    ...
                    <div class="tab-pane fade" id="account-allowances">
                      ...
                      <div class="card-body pb-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="amount_option"><?php echo $this->lang->line('xin_amount_option'); ?><i class="hrsale-asterisk">*</i></label>
                    ...
                    <div class="tab-pane fade" id="account-commissions">
                      ...
                      <div class="card-body pb-2">
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="is_commission_taxable"><?php echo $this->lang->line('xin_salary_commission_options'); ?><i class="hrsale-asterisk">*</i></label>
                    ...
                    <div class="tab-pane fade" id="account-other_payment">
                      ...
                      <div class="card-body pb-2">
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="is_otherpayment_taxable"><?php echo $this->lang->line('xin_salary_otherpayment_options'); ?><i class="hrsale-asterisk">*</i></label>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <?php foreach ($overtimeamount as $amount) { ?>
                                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_overtime_rate'); ?>" name="overtime_rate" type="text" value="<?php echo $amount->overtime_rate ?>" id="overtime_rate" readonly>
                              <?php } ?>
                            </div>
                          </div>
                        </div>
                    ...
                    <!-- Effective Date -->
                    <div class="tab-pane fade" id="effectiveDate">
                      <div class="card-header with-elements"> <span class="card-header-title mr-2"> <strong> <?php echo $this->lang->line('xin_employee_update_salary'); ?></strong> </span> </div>
                      <div class="card-body pb-2">
                        <?php $attributes = array('name' => 'update_salary_allowances', 'id' => 'update_salary_allowances', 'autocomplete' => 'off'); ?>
                        <?php $hidden = array('u_basic_info' => 'UPDATE'); ?>
                        <?php echo form_open('admin/employees/UpdateSalary', $attributes, $hidden); ?>
                        <?php
                        $data_usr4 = array(
                          'type'  => 'hidden',
                          'name'  => 'user_id',
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="month_year"><?php echo $this->lang->line('xin_salary_title'); ?><i class="hrsale-asterisk">*</i></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_salary_title'); ?>" name="loan_deduction_title" type="text" value="<?php echo $basic_salary; ?>" readonly>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="edu_role">Update <?php echo $this->lang->line('xin_salary_title'); ?><i class="hrsale-asterisk">*</i></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_salary_title'); ?>" name="basic_salary" type="text" id="basic_salary" required>
                            </div>
                          </div>
                        </div>
                        <?php
                          $getAllowances = $this->Employees_model->set_employee_allowances($eid);
                          $date= date('Y-m-d', strtotime('last day of last month'));
                            foreach($getAllowances->result() as $allowances) { ?>
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="month_year"><?php echo $allowances->allowance_title ?></i></label>
                                  <input class="form-control" placeholder="<?php echo $allowances->allowance_title ?>" name="start_date" type="text" value="<?php echo $allowances->allowance_amount ?>" readonly>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="end_date">Update <?php echo $allowances->allowance_title ?></i></label>
                                  <input class="form-control" placeholder="<?php echo $allowances->allowance_title ?>" name="update_allowances[]" type="text" required>
                                </div>
                              </div>
                            </div>
                        <?php } ?>
