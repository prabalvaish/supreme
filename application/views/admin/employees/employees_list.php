        ...
        <div class="card-body">
          ...
          <div class="form-body">
            <div class="row">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="middle_name"><?php echo $this->lang->line('xin_employee_middle_name'); ?><i class="hrsale-asterisk">*</i></label>
                ...
                <div class="row">
                  ...
                  <!-- <div class="col-md-6">
                    <div class="form-group">
                      <div id="salary_type">
                        <label for="salary_type">Select Salary Type<i class="hrsale-asterisk">*</i></label>
                        <select id="salary_select" name="salary_select" class="form-control">
                          <option value disalbe selected></option>
                  ...
                  <!-- <div class="col-md-5">
                    <div class="form-group"> -->
                      <!-- <div id="salary_month">
                        <div id="1">
                          <div id="QuestionD">
                            <label for="salary_type">Select Days<i class="hrsale-asterisk">*</i></label>
                            <select id="month_select" class="form-control">
                              <option value disalbe selected></option>
                              <option value="G">26/27 Days</option>
                              <option value="H">30/31 Days</option>
                            </select>
                          </div>
                        </div>
                      </div> -->
                      <!-- <div id="2" style="display: none;">
                        <div id="salary_days">
                          ...
                          <select id="days_select" class="form-control">
                            <option value disalbe selected></option>
                            <option value="I">25 Days</option>
                            <option value="I">26 Days</option>
                            <option value="J">27 Days</option>
                          </select>
                        </div>
                      </div> -->
                    <!-- </div>
                  ...
                  <!-- Salary -->
                    <div id="salary_ajax">
                      <input type ="hidden" placeholder="<?php echo $this->lang->line('dashboard_salary'); ?>" name="basic_salary" style="display:none;">
                    </div>
                  <div class="col-md-6">
                    <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="row">
                  <div class="col-md-6">
                    <!-- Employee ID -->
                    <!-- <div class="form-group" id="emp_id_ajax">
                    <label for="employee_id"><?php echo $this->lang->line('dashboard_employee_id'); ?><i class="hrsale-asterisk">*</i></label>
                    <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_employee_id'); ?>" name="employee_id"  >
                    </div> -->
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
              ...
              <!-- <div class="col-md-4">
              <div class="form-group">
                <label for="sallary"><?php echo $this->lang->line('dashboard_salary'); ?><i class="hrsale-asterisk">*</i></label>
                <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_salary'); ?>" name="basic_salary" type="text" value="">
              </div>
            </div>
            </div> -->
            ...
            <?php if ($count_module_attributes > 0) : ?>
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <input type="checkbox" id="pf_allow" name="pf_allow" value='1'>
            ...
            <div class="col-md-6">
              <input type="radio" id="old" name="tds_type" value="0">
              <label for="male">Old Regime For TDS</label><br>
              <input type="radio" id="new" name="tds_type" value="1">
          ...
          <table class="datatables-demo table table-striped table-bordered" id="xin_table">
            <thead>
              <tr>
                ...
                <th><?php echo $this->lang->line('xin_employee_roleappoff'); ?></th>
                <!-- <th><?php echo $this->lang->line('xin_employee_roleappappo'); ?></th> -->
              </tr>
            </thead>
          </table>
        </div>
