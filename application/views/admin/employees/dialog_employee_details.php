...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('shu/employees/e_location_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_location = $('#xin_table_location').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("shu/employees/location") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
    ...
    <div class="col-md-3">
      <div class="form-group">
        ...
        <select name="is_allowance_taxable" id="is_allowance_taxable" class="form-control" data-plugin="select_hrm">
          ...
          <option value="1" <?php if($is_allowance_taxable==1):?> selected="selected" <?php endif;?>><?php echo $this->lang->line('xin_fully_taxable');?></option>
          <option value="2" <?php if($is_allowance_taxable==2):?> selected="selected" <?php endif;?>><?php echo $this->lang->line('xin_partially_taxable');?></option>
        </select>
      </div>
    </div>
    <div class="col-md-3">
      <div class="form-group">
        ...
        <select name="amount_option" class="form-control" data-plugin="select_hrm">
          <option value="0" <?php if($amount_option==0):?> selected="selected" <?php endif;?>><?php echo $this->lang->line('xin_title_tax_fixed');?></option>
          <option value="1" <?php if($amount_option==1):?> selected="selected" <?php endif;?>><?php echo $this->lang->line('xin_title_tax_percent');?></option>
        </select>
      </div>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-3">
      <div class="form-group">
        ...
        <select name="is_commission_taxable" class="form-control" data-plugin="select_hrm">
          <option value="0" <?php if($is_commission_taxable==0):?> selected="selected" <?php endif;?>><?php echo $this->lang->line('xin_salary_allowance_non_taxable');?></option>
          <option value="1" <?php if($is_commission_taxable==1):?> selected="selected" <?php endif;?>><?php echo $this->lang->line('xin_fully_taxable');?></option>
          <option value="2" <?php if($is_commission_taxable==2):?> selected="selected" <?php endif;?>><?php echo $this->lang->line('xin_partially_taxable');?></option>
        </select>
      </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <select name="statutory_options" class="form-control" data-plugin="select_hrm">
          <option value="0" <?php if($statutory_options==0):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_title_tax_fixed');?></option>
          <option value="1" <?php if($statutory_options==1):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_title_tax_percent');?></option>
        </select>
      </div>
    </div>
    <div class="col-md-5">
    ...
    <div class="col-md-3">
      <div class="form-group">
        ...
        <select name="is_otherpayment_taxable" class="form-control" data-plugin="select_hrm">
          <option value="0" <?php if($is_otherpayment_taxable==0):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_salary_allowance_non_taxable');?></option>
          <option value="1" <?php if($is_otherpayment_taxable==1):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_fully_taxable');?></option>
          <option value="2" <?php if($is_otherpayment_taxable==2):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_partially_taxable');?></option>
        </select>
      </div>
    </div>
    <div class="col-md-3">
