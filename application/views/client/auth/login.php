...
#hrload-img {
  ...
  <div class="authentication-wrapper authentication-1 px-4">
    ...
    <!-- Form -->
    <?php $ilogn_info = 'client1@ezmata.com';?>
	<?php $ilogn_info2 = 'client2@ezmata.com';?>
    ...
    <div class="form-group">
        <label class="form-label"><?php echo $this->lang->line('xin_login_email');?></label>
        <input type="text" class="form-control" id="iusername" name="iusername" placeholder="<?php echo $this->lang->line('xin_login_email');?>">
      </div>
    <div class="form-group">
        <label class="form-label d-flex justify-content-between align-items-end">
        <div><?php echo $this->lang->line('xin_login_enter_password');?></div>
        <a href="<?php echo site_url('client/auth/forgot_password');?>" class="d-block small"><?php echo $this->lang->line('xin_forgot_password_link');?></a>
        </label>
    ...
    <div class="d-flex justify-content-between align-items-center m-0">
        ...
        <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => 'btn btn-primary save mr-2', 'content' => '<i class="fa fa-lock"></i> '.$this->lang->line('xin_login'))); ?> </div>
    <?php echo form_close(); ?> 
    <!-- / Form -->
...
<script type="text/javascript" src="<?php echo base_url();?>skin/hrsale_vendor/hrsale_scripts/xin_client_login.js"></script> 
<script type="text/javascript">
$(document).ready(function(){
